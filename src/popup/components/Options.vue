            ...
            <form @submit.prevent="onSubmit">
                <div class="control">
                    <label class="checkbox">
                        <input v-model="form.newPostNotification" type="checkbox">
                ...
                <div v-if="authenticated" class="control">
                    <label class="label">
                        <strong>Badge counter type</strong>
                    </label>

                    <label class="radio">
                        <input v-model="form.badgeTextType" type="radio" value="all">
                        <span>All</span>
                    </label>

                    <label class="radio">
                        <input v-model="form.badgeTextType" type="radio" value="unreadNotifications">
                    ...
                    <label class="radio">
                        <input
                            ...
                            :disabled="!form.newPostNotification"
                            type="radio"
                            value="newPosts"
                        >
                        <span>New Posts</span>
